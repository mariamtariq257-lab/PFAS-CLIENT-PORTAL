...
const PROJECT_META = {
  "shrimps": {
    ...
    team: [
      { name: "Ammar Yasir",    role: "Team Lead",       email: "ammar.yasir@pfas.com.pk",   color: "navy"   },
      { name: "Khalid Safdar",  role: "Senior Analyst",  email: "khalid.safdar@pfas.pk",     color: "gold"   },
      { name: "Meiraj N. Khan", role: "Analyst",         email: "meiraj.khan@pfas.pk",       color: "green"  }
    ]
  },
  "pcmmdc": {
    ...
    team: [
      { name: "Hashim Riaz",             role: "Project Manager",   email: "hashim.riaz@pfas.com.pk",    color: "navy"   },
      { name: "Muhammad Fahad Tanveer",  role: "PM Team Lead",      email: "fahad.tanveer@pfas.pk",      color: "gold"   },
      { name: "Qamar Sb",                role: "HR Expert",         email: "—",                          color: "purple" }
    ]
  },
  "p4a": {
    ...
    team: [
      { name: "Hashim Riaz",            role: "Team Lead",            email: "hashim.riaz@pfas.com.pk",   color: "navy"   },
  ...
  "fiedmc-m3ic": {
    ...
    team: [
      ...
      { name: "Hashim Riaz",            role: "Senior Advisor",  email: "hashim.riaz@pfas.com.pk",  color: "gold" }
    ]
  },
  "fiedmc-sbp": {
  ...
  "energy": {
    ...
    team: [
      { name: "Muhammad Fahad Tanveer", role: "Project Lead",    email: "fahad.tanveer@pfas.pk",     color: "navy"  },
      { name: "Hashim Riaz",            role: "Senior Advisor",  email: "hashim.riaz@pfas.com.pk",   color: "gold"  },
      { name: "Awais Khan",             role: "Analyst",         email: "awais.khan@pfas.com.pk",    color: "green" }
    ]
  },
  "bot1":  { type: "Dualization BOT-PPP",        onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/C%26W/BOT-1%20Dualization%20of%20Deplapur-Pakpattan-Vehari%20Road", teamsChannel: "https://teams.microsoft.com/l/channel/BOT-1%20Depalpur-Pakpattan/C%26W%20Roads", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20BOT-1%20Discussion", team: [{ name: "Abdul Wahab", role: "Project Lead", email: "abdul.wahab@pfas.com.pk", color: "navy" }, { name: "Umar Paracha", role: "Senior Analyst", email: "umar.paracha@pfas.com.pk", color: "gold" }, { name: "Husnain Siddique", role: "Senior Associate", email: "husnain.siddique@pfas.pk", color: "green" }, { name: "Ali Jibran", role: "Analyst", email: "ali.jibran@pfas.com.pk", color: "purple" }] },
  "bot2":  { type: "Dualization BOT-PPP",        onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/C%26W/BOT-2-%20Dualization%20of%20Chiragabad-Jhan-Shorkot%20Road", teamsChannel: "https://teams.microsoft.com/l/channel/BOT-2%20Chiragabad-Jhang/C%26W%20Roads",   teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20BOT-2%20Discussion", team: [{ name: "Abdul Wahab", role: "Project Lead", email: "abdul.wahab@pfas.com.pk", color: "navy" }, { name: "Umar Paracha", role: "Analyst", email: "umar.paracha@pfas.com.pk", color: "gold" }] },
  "bot3":  { type: "Dualization BOT-PPP",        onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/C%26W/BOT-3-%20Dualization%20of%20Muzaffargarh-Alipur-TM%20panah%20road", teamsChannel: "https://teams.microsoft.com/l/channel/BOT-3%20Muzaffargarh-Alipur/C%26W%20Roads", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20BOT-3%20Discussion", team: [{ name: "Abdul Wahab", role: "Project Lead", email: "abdul.wahab@pfas.com.pk", color: "navy" }, { name: "Umar Paracha", role: "Analyst", email: "umar.paracha@pfas.com.pk", color: "gold" }] },
  "bot4":  { type: "Add Carriageway BOT-PPP",    onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/C%26W/BOT-4-%20Add%20Carriageway%20of%20sahiwal-samundari%20%20Road", teamsChannel: "https://teams.microsoft.com/l/channel/BOT-4%20Sahiwal-Samundari/C%26W%20Roads",   teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20BOT-4%20Discussion", team: [{ name: "Abdul Wahab", role: "Project Lead", email: "abdul.wahab@pfas.com.pk", color: "navy" }, { name: "Umar Paracha", role: "Analyst", email: "umar.paracha@pfas.com.pk", color: "gold" }] },
  "bot5":  { type: "Add Carriageway BOT-PPP",    onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/C%26W/BOT%205%20Add%20Carriageway%20to%20Bahawalpur-Jhangra%20sharqi%20Road", teamsChannel: "https://teams.microsoft.com/l/channel/BOT-5%20Bahawalpur-Jhangra/C%26W%20Roads",  teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20BOT-5%20Discussion", team: [{ name: "Abdul Wahab", role: "Project Lead", email: "abdul.wahab@pfas.com.pk", color: "navy" }, { name: "Umar Paracha", role: "Analyst", email: "umar.paracha@pfas.com.pk", color: "gold" }] },
  "om-roads": { type: "Operations & Maintenance PPP", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/C%26W/18%20O%26M%20Roads-PPP", teamsChannel: "https://teams.microsoft.com/l/channel/18%20O%26M%20Roads/C%26W%20Roads", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%2018%20O%26M%20Roads%20Discussion", team: [{ name: "Abdul Wahab", role: "Project Lead", email: "abdul.wahab@pfas.com.pk", color: "navy" }, { name: "Husnain Siddique", role: "Senior Associate", email: "husnain.siddique@pfas.pk", color: "gold" }, { name: "Umar Paracha", role: "Senior Analyst", email: "umar.paracha@pfas.com.pk", color: "green" }, { name: "Ali Jibran", role: "Analyst", email: "ali.jibran@pfas.com.pk", color: "purple" }] },
  "wildlife-bansra": { type: "Site Advisory", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/Wildlife/Bansara%20Gali%20Wildlife", teamsChannel: "https://teams.microsoft.com/l/channel/Bansra%20Gali%20Wildlife/Wildlife", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20Bansra%20Gali", team: [] },
  "wildlife-changa": { type: "Site Advisory", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/Wildlife/Changa%20Manga%20wildlife", teamsChannel: "https://teams.microsoft.com/l/channel/Changa%20Manga%20Wildlife/Wildlife", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20Changa%20Manga", team: [] },
  "tam":  { type: "Project Advisory", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/TAM/Time%20Travel%20Park", teamsChannel: "https://teams.microsoft.com/l/channel/Time%20Travel%20Theme%20Park/TAM", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20TAM%20Theme%20Park", team: [{ name: "Ammar Yasir", role: "Team Lead", email: "ammar.yasir@pfas.com.pk", color: "navy" }, { name: "Khalid Safdar", role: "Senior Analyst", email: "khalid.safdar@pfas.pk", color: "gold" }, { name: "Meiraj N. Khan", role: "Analyst", email: "meiraj.khan@pfas.pk", color: "green" }, { name: "Azmat Nawaz", role: "Chief Operating Officer", email: "azmat.nawaz@pfas.pk", color: "purple" }] },
  "pha":  { type: "Financial Sustainability Advisory", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/PHA", teamsChannel: "https://teams.microsoft.com/l/channel/PHA%20Lahore/PHA", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20PHA%20Lahore", team: [{ name: "Hashim Riaz", role: "Project Lead", email: "hashim.riaz@pfas.com.pk", color: "navy" }] },
  "pbf":  { type: "Welfare Fund Advisory", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/Punjab%20Benevolent%20Fund/Punjab%20Govt%20Employees%20welfare%20fund", teamsChannel: "https://teams.microsoft.com/l/channel/Employees%20Welfare%20Fund/Punjab%20Benevolent%20Fund", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20PBF%20Welfare", team: [{ name: "Muhammad Aejwat", role: "Senior Analyst", email: "muhammad.aejwat@pfas.pk", color: "navy" }, { name: "Harris Ghaffar", role: "Associate Financial Advisory", email: "harris.ghaffar@pfas.pk", color: "gold" }] },
  ...
  "vss":  { type: "Voluntary Separation Scheme Advisory", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations/Finance%20Department", teamsChannel: "https://teams.microsoft.com/l/channel/VSS%20Engagement/Finance%20Department", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20VSS%20Engagement", team: [{ name: "Hashim Riaz", role: "Team Lead", email: "hashim.riaz@pfas.com.pk", color: "navy" }, { name: "Muhammad Fahad Tanveer", role: "Project Manager", email: "fahad.tanveer@pfas.pk", color: "gold" }] },
  "hed":  { type: "Strategic Advisory", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations", teamsChannel: "https://teams.microsoft.com/l/channel/HED%20Engagement/Higher%20Education%20Dept", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20HED", team: [{ name: "Husnain Siddique", role: "Senior Associate", email: "husnain.siddique@pfas.pk", color: "navy" }, { name: "Ali Jibran", role: "Analyst", email: "ali.jibran@pfas.com.pk", color: "gold" }] },
  "phimc":{ type: "Healthcare Feasibility Advisory", onedriveUrl: "https://pfaspk-my.sharepoint.com/personal/hamza_naeem_pfas_pk/Documents/PFAS%20Operations", teamsChannel: "https://teams.microsoft.com/l/channel/6%20Hospitals%20Feasibility/PHIMC", teamsMeeting: "https://teams.microsoft.com/l/meeting/new?subject=PFAS%20%E2%80%94%20PHIMC%206%20Hospitals", team: [{ name: "Hashim Riaz", role: "Team Lead", email: "hashim.riaz@pfas.com.pk", color: "navy" }, { name: "Muhammad Fahad Tanveer", role: "Project Manager", email: "fahad.tanveer@pfas.pk", color: "gold" }, { name: "Awais Khan", role: "Analyst", email: "awais.khan@pfas.com.pk", color: "green" }, { name: "Abdul Wahab", role: "Analyst", email: "abdul.wahab@pfas.com.pk", color: "purple" }] },
};
